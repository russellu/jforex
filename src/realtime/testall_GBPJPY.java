...
public class testall_GBPJPY {
	...
	public static void main(String[]args){
		...
		double tp = 0.01+53*0.02 ; 
		double stop = 0.05+21*0.05 ; 
...
//			LinePlot lp = new LinePlot() ; 
			...
			for(int i=0;i<2000;i++){
				...
				int index = (int)(arr.size()*Math.random()*.85) ;			
				testall_GBPJPY p2 = new testall_GBPJPY() ; 
				p2.mthresh = i+99999999 ; 
				p2.tps[0] = tp ; 
				p2.stops[0] = -stop ; 			
				int icount=0;
