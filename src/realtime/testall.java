...
public class testall {
	...
	public static void main(String[]args){
		...
		for(double m1=.000001;m1<.0001;m1+=.000002){
		...
		ArrayList<ArrayList<Double>> alist = new ArrayList<ArrayList<Double>>() ; 
			...
			for(int i=0;i<1000;i++){
				...
				int[] params = {11,115,158} ; 
				testall p2 = new testall(params) ; 
				p2.mthresh = i+99999999 ; p2.slopeThresh = m1 ; 
				p2.tps[0] = tp ; 
				p2.stops[0] = -stop ; 			
				int icount=0;
			...
			SaveArray.saveArrayList(alist, "lol_"+formatter.format(m1)+".txt");
		}
