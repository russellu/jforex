...
public class permute_single {
	...
	public static void main(String[]args){
		ArrayList<dukas> arr = parseDukas.parseOne("C:\\Users\\Acer\\Documents\\","EURUSD_UTC_1 Min_Bid_2006.02.04_2015.02.04.csv") ;
		...
		ArrayList<ArrayList<Double>> alist = new ArrayList<ArrayList<Double>>() ; 
			...
			for(int i=0;i<10000;i++){
				...
				permute_single p2 = new permute_single() ; 
